       ...
       <!--  <li class="header">MENU DE NAVEGAÇÃO</li> -->
        ...
        <?php if (controleAcessoMenuUsuarios()){ ?>
          <li class="treeview <?php if ($menu_ativo === 'usuarios'){echo 'active';}?> ">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('home/cadastra_usuario')?>"><i class="fa fa-user-plus"></i> Cadastro</a></li>
              <li><a href="<?php echo base_url('home/consulta_usuario')?>"><i class="fa fa-users"></i> Consulta</a></li>
              <li><a href="<?php echo base_url('home/lista_usuario')?>"><i class="fa fa-list"></i> Lista</a></li>
            </ul>
          </li>
        <?php } ?>
        ...
        <?php if (controleAcessoMenuClientes()){ ?>
          <li class="treeview <?php if ($menu_ativo === 'clientes'){echo 'active';}?> ">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('cliente/cadastra_cliente')?>"><i class="fa fa-user-plus"></i> Cadastro</a></li>
              <li><a href="<?php echo base_url('cliente/consulta_cliente')?>"><i class="fa fa-users"></i> Consulta</a></li>
              <li><a href="<?php echo base_url('cliente/lista_cliente')?>"><i class="fa fa-list"></i> Lista</a></li>
            </ul>
          </li>
        <?php } ?>
        ...
        <?php if (controleAcessoMenuProdutos()){ ?>
          <li class="treeview <?php if ($menu_ativo === 'produtos'){echo 'active';}?> ">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('produto/cadastra_produto')?>"><i class="fa fa-plus"></i> Cadastro</a></li>
              <li><a href="<?php echo base_url('produto/consulta_produto')?>"><i class="fa fa-search"></i> Consulta</a></li>
              <li><a href="<?php echo base_url('produto/lista_produto')?>"><i class="fa fa-list"></i> Lista</a></li>
            </ul>
          </li>
        <?php } ?>
        ...
        <?php if (controleAcessoMenuPedidos()){ ?>
          <li class="treeview <?php if ($menu_ativo === 'pedidos'){echo 'active';}?> ">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('pedido/novo_pedido')?>"><i class="fa fa-user-plus"></i> Novo</a></li>
