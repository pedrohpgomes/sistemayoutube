  <header class="main-header">
    <?php
      ...
      $emailUsuario = $dadosSession['emailUsuario'];
      $datacadastro = $dadosSession['datacadastro'];
    ?>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/dist/img/user2.jpg')?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Cadastrado desde <?php echo date('d/m/Y H:i',strtotime($datacadastro)); ?><br><?php echo "E-mail: ".$emailUsuario; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('profile')?>" class="btn btn-default btn-flat">Perfil</a>
                </div>
